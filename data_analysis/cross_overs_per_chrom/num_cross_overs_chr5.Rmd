...
output:
  html_document:
    ...
    toc: no
---
# **number of cross overs per chromosome 5 - arabidopsis**
...
table = read.delim(file="chromosome_5_crosses.txt")
table$X <- NULL
melted = melt(table)
...
write.table(table1, file="chr5_gamma_params.txt", sep="\t", row.names = FALSE, quote=FALSE)
```
